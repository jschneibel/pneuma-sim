...
export const ELEMENT_CONTACT_SIZE = 6;
export const ELEMENT_CONTACT_LINE_WIDTH = 1.65;
export const PNEUMATIC_CONTACT_COLOR = "#6c6";
export const PNEUMATIC_CONTACT_COLOR_HIGHLIGHTED = "#8e8";
export const ELECTRIC_CONTACT_COLOR = "#c66";
export const ELECTRIC_CONTACT_COLOR_HIGHLIGHTED = "#e88";
